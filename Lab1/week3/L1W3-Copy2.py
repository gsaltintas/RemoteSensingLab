...
#             print(dx, dy, ncc)
    ...
    # Save results
    np.savez(f'outputs/matches_scene_{SCENE_NUMBER}_{2*template_radius+1}x{2*template_radius+1}_stride_{stride}.npz', matched_points_x_img1, matched_points_y_img1, matched_points_x_img2, matched_points_y_img2, matched_points_ncc, ncc_vis, displacement_vis)
